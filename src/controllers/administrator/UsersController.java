...
public class UsersController implements Initializable {
    ...
    @FXML
    private TableColumn<User, Void> modifyTableColumn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        modifyTableColumn.setCellFactory(column -> {
            return new TableCell<User, Void>(){
                private Button button = new Button("Modify");
                {
                    button.setOnAction(event -> {
                        User user = getTableView().getItems().get(getIndex());
                        try{
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("./../../layouts/administrator/modify_user_form_layout.fxml"));
                            Parent parent = loader.load();
                            ModifyUserFormController controller = loader.getController();
                            controller.setUser(user);
                            controller.setReturnTableView(getTableView(), getIndex());
